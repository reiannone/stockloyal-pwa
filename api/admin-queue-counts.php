 ...
 *                          (active picks + points > 0 + no in-flight orders for those symbols)
...
try {
    ...
    // and no in-flight orders (pending through submitted) for the same
    // symbol+merchant already in the pipeline.
