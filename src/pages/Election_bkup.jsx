      ...
      {selection === "monthly" && (
        <div className="mt-4">
          <p className="body-text mb-4">
            ...
            <strong>{memberName}</strong> to automatically convert the loyalty
            reward points you earn on the {textSweepDay} of each month into a cash-equivalent amount,
            which will be invested in your most recent stock allocation in your <em>Basket</em>. You may
