...
export default function Wallet() {
  ...
  useEffect(() => {
    ...
    (async () => {
      ...
      try {
        ...
        // sync values into localStorage for quick access
        try {
  ...
  return (
    <div className="wallet-container">
      ...
      >
        <h2 className="wallet-heading" style={{ margin: 0 }}>
      ...
      <p className="wallet-intro" style={{ marginTop: 8 }}>
        ...
        >
          ...
          <div style={{ textAlign: "right" }}>
            <div className="wallet-cash" style={{ margin: 0 }}>
              {formatDollars(cashBalance)}
            </div>
            <div className="caption" style={{ marginTop: 6 }}>
              Points: <strong>{formatPoints(points)}</strong>
            </div>
            {sweepPct !== null && (
      ...
      <div className="card card--accent" style={{ marginTop: 14 }}>
        ...
        >
          {/* ✅ Pass state to Portfolio */}
          <button
            className="btn-secondary"
            onClick={() => navigate("/portfolio", { state: { showAll: false } })}
          >
            View Portfolio
          </button>
          <button
            className="btn-secondary"
            onClick={() => navigate("/portfolio", { state: { showAll: true } })}
          >
            Transactions
          </button>
        </div>
      ...
      <p className="wallet-note" style={{ marginTop: 12 }}>
        Investment portfolio reflects shares purchased through the StockLoyal app
        only.{" "}
